...
namespace LARPWorks.Cyaniel.Models
{
    ...
    public partial class AdvancementListFactGate : LarpworksDatabase.Record<AdvancementListFactGate>  
    {
		...
		[Column] public int RequiredFactId { get; set; }





		[Column] public int? MinimumRankRequired { get; set; }
    ...
    public partial class AdvancementListFactModifier : LarpworksDatabase.Record<AdvancementListFactModifier>  
    {
		...
		[Column] public int FactRequirementId { get; set; }
	...
	[TableName("larpworks.AdvancementListFacts")]
    ...
    public partial class AdvancementListFact : LarpworksDatabase.Record<AdvancementListFact>  
    {
	...
	[TableName("larpworks.CharacterFacts")]
    ...
    public partial class CharacterFact : LarpworksDatabase.Record<CharacterFact>  
    {
    ...
    public partial class FactType : LarpworksDatabase.Record<FactType>  
    {
    ...
    public partial class Fact : LarpworksDatabase.Record<Fact>  
    {
		...
		[Column] public int FactTypeId { get; set; }
